...
public class Country { 
   ...
   // continent bonuses
   public final static int NORTH_AMERICA_BONUS = 5;
   public final static int SOUTH_AMERICA_BONUS = 2;
   public final static int EUROPE_BONUS = 5;
   public final static int AFRICA_BONUS = 3;
   public final static int ASIA_BONUS = 7;
   public final static int AUSTRALIA_BONUS = 2;
